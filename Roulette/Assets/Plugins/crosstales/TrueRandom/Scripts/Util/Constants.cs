namespace Crosstales.TrueRandom.Util
{
   ...
   public abstract class Constants : Common.Util.BaseConstants
   {
      ...
      public const string ASSET_VERSION = "2020.3.2";

      /// <summary>Build number of the asset.</summary>
      public const int ASSET_BUILD = 20201016;
      ...
      public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2020, 10, 16);
