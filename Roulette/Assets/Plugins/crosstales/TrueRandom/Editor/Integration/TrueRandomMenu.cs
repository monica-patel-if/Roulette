...
namespace Crosstales.TrueRandom.EditorIntegration
{
   ...
   {
      [MenuItem("Tools/" + Util.Constants.ASSET_NAME + "/Prefabs/" + Util.Constants.TRUERANDOM_SCENE_OBJECT_NAME, false, EditorHelper.MENU_ID + 20)]
      private static void AddTrueRandom()
      {
         EditorHelper.InstantiatePrefab(Util.Constants.TRUERANDOM_SCENE_OBJECT_NAME);
      }

      [MenuItem("Tools/" + Util.Constants.ASSET_NAME + "/Prefabs/" + Util.Constants.TRUERANDOM_SCENE_OBJECT_NAME, true)]
      ...
      private static void ShowInfo()
      {
         EditorUtility.DisplayDialog(Util.Constants.ASSET_NAME + " - About",
            ...
            System.Environment.NewLine +
            "© 2016-2020 by " + Util.Constants.ASSET_AUTHOR +
            System.Environment.NewLine +
            System.Environment.NewLine +
