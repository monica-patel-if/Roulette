...
namespace Crosstales.Common.Util
{
   ...
   public class SerializableDictionary<TKey, TVal> : System.Collections.Generic.Dictionary<TKey, TVal>, System.Xml.Serialization.IXmlSerializable, System.Runtime.Serialization.ISerializable
   {
      ...
      protected SerializableDictionary(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
      {
         ...
         {
            System.Collections.Generic.KeyValuePair<TKey, TVal> kvp = (System.Collections.Generic.KeyValuePair<TKey, TVal>)info.GetValue($"Item{ii}", typeof(System.Collections.Generic.KeyValuePair<TKey, TVal>));
      ...
      private System.Xml.Serialization.XmlSerializer ValueSerializer => valueSerializer ?? (valueSerializer = new System.Xml.Serialization.XmlSerializer(typeof(TVal)));

      private System.Xml.Serialization.XmlSerializer KeySerializer => keySerializer ?? (keySerializer = new System.Xml.Serialization.XmlSerializer(typeof(TKey)));
