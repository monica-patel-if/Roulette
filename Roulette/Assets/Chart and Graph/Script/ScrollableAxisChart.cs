...
namespace ChartAndGraph
{
    ...
    public abstract class ScrollableAxisChart : AxisChart
    {
        ...
        protected string StringFromAxisFormat(double val, AxisBase axis,bool isX)
        {
            if (axis == null)
        ...
        protected string StringFromAxisFormat(double val, AxisBase axis, int fractionDigits,bool isX)
        {
            var dic = HorizontalValueToStringMap;
            if (isX == false)
                dic = VerticalValueToStringMap;
       ...
       //     Debug.Log("try get " + val + " count is " + dic.Count);
        ...
        private void HandleMouseDrag()
        {
            ...
            bool mouseIn = RectTransformUtility.RectangleContainsScreenPoint(transform as RectTransform, Input.mousePosition,Camera.main);
