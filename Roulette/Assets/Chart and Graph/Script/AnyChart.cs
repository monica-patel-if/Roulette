...
namespace ChartAndGraph
{
    ...
    public abstract class AnyChart : MonoBehaviour, IInternalUse, ISerializationCallbackReceiver
    {
        ...
        private Dictionary<double, string> mHorizontalValueToStringMap = new Dictionary<double, string>();
        private Dictionary<double, string> mVerticalValueToStringMap = new Dictionary<double, string>();
